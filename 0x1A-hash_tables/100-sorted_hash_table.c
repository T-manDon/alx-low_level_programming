...
/**
 * sorted_list - brings in a new nod
 * @ht: ht pointer
 *
 * @new_node: the node
 */
...
/**
 * shash_table_create - used to mae assortedd ht
 * @size: size of the HT
 * Return: pointer HT
 *
 */
...
/**
 * shash_table_set - populates the ht
 * @ht: points to HT
 *
 * @key: key to HT
 * @value: value variable
 * Return: 1 succeess, 0 otherwise
 */
...
/**
 * shash_table_get - reitrivesHT value
 * @ht: points to HT
 *
 * @key: key
...
/**
 * shash_table_print - prints key value
 *
 * @ht: the HT pointer
 */
...
/**
 * shash_table_print_rev - prints reverse value
 *
 * @ht: points to HT
 */
